...
def main() -> None:  # noqa: D103
    ...
    # Usuario
    # PARCHE 1 - Usuario especial para sector oriente
    usuario = 'product_sensibility_sector_oriente'
    ...
    # PARCHE 2 - Nueva tabla para Sector Oriente
    esquema = 'PRECIO_PROMOCIONES'
    tabla = 'PRODUCT_SENSIBILITY_SECTOR_ORIENTE'
    ...
    tabla_sofisticacion = 'CUSTOMER_SEGMENTATION_SOPHISTICATION_SECTOR_ORIENTE'
    ...
    uploadFrame(
        ...
        table_ddl_json_path=os.path.join('gbq_objects',
                                        'ingest_product_sensibility_sector_oriente.json'),
        project=proyecto,
        gbq_client=gbq_client,
        if_exists='append'
    )
