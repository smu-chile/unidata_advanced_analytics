...
def sumar_mes(monthid: int) -> int:  # noqa: D103
    year = monthid // 100
    month = monthid % 100
    month += 1
    if month == 13:
...
def main() -> None:  # noqa: D103
    ...
    print(' ')  # noqa: T201
    print('--------------------')  # noqa: T201
    print(f'Se inicia el proceso para {store_banner_mayusculas}')  # noqa: T201
    print('--------------------')  # noqa: T201
    print(f'Año y mes inicial: {fecha_inicial_str}')  # noqa: T201
    print(f'Año y mes final: {fecha_final_str}')  # noqa: T201
    ...
    print('Inicia la consulta de principal ...')  # noqa: T201
    ...
    print('Termina la consulta de principal.')  # noqa: T201
    ...
    print('Se lee el genfix desde PDA')  # noqa: T201
    ...
    if tamaño_original != tamaño_final:
        print(f'Se eliminaron {tamaño_original-tamaño_final} elementos duplicados')  # noqa: T201
    ...
    print('Se agrega media armonica')  # noqa: T201
    ...
    print('Se crean los clúster KVI')  # noqa: T201
    ...
    print('Inicia la consulta de gasto total ...')  # noqa: T201
    ...
    print('Se hace el merge con gasto de productos y se imponen ciertas categorias')  # noqa: T201
    #----------------------------------------------------------------------
    # ENDREGION
    ...
    print('Se crea dataframe final')  # noqa: T201
    ...
    print('Se fuerzan los productos señalados por equipo de Pricing')  # noqa: T201
    ...
    print('Se sube la tabla a GCP')  # noqa: T201
