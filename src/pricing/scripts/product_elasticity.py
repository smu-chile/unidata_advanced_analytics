...
SQL_QUERIES = QueryDict({    # Region: Explicación de query
    ...
    FROM `${proyecto}.ML_LAB.SKU_SUBSTITUTES_BY_CATEGORY`
    WHERE store_banner = '${store_banner}'
...
def main() -> None:  # noqa: D103
    ...
    def obtener_elasticidad_por_similitud(material_origen, peso_origen):  # noqa: ANN001, ANN202
    ...
    def contagiar_por_subcategoria(row):  # noqa: ANN001, ANN202
    ...
    def contagiar_por_categoria(row):  # noqa: ANN001, ANN202
        cat = row['categoria']
    ...
    print(df_resultados['elasticidad_contagiada'].describe())  # noqa: T201
