...
def main() -> None:  # noqa: D103
    ...
    esquema = 'TMP'
    # PARCHE TEMPORAL
    tabla = f'TMP_REGRESSION_DATA_{use}_10SUS'
    tmp_path_table = f'{proyecto}.{esquema}.{tabla}'


    # Nombre archivo Json
    if use == 'FORECAST':
        nombre_json = 'ingest_regression_processed_data_forecast_10sus.json'
    elif use == 'ELASTICITY':
    ...
    df_parejas_6 = obtenerParejasPorRelevance(df_sust, df_material_ean, 6)
    df_parejas_7 = obtenerParejasPorRelevance(df_sust, df_material_ean, 7)
    df_parejas_8 = obtenerParejasPorRelevance(df_sust, df_material_ean, 8)
    df_parejas_9 = obtenerParejasPorRelevance(df_sust, df_material_ean, 9)
    df_parejas_10 = obtenerParejasPorRelevance(df_sust, df_material_ean, 10)
    ...
    columnas_deseadas = [
        ...
        'ean_sustituto_4', 'ean_sustituto_5','ean_sustituto_6',
        'ean_sustituto_7','ean_sustituto_8','ean_sustituto_9',
        'ean_sustituto_10',
