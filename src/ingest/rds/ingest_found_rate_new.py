"""Contains the DAG that loads the found rate table from ecommerce."""
# Default
import json
import platform
import importlib
...
SUBPROJECT_NAME = 'rds'
dag_args = {
    'dag_id': 'ingest_found_rate_new',
    'schedule_interval': '0 4 * * *',
    'dagrun_timeout': None,
    'catchup': False,
    'max_active_runs': 1,
    'concurrency': 1,
    'tags': [PROJECT_NAME, SUBPROJECT_NAME, 'FOUND RATE', 'ilopeze'],
    'default_args': {
