"""Contains the DAG that loads the cumplimiento despacho alvi from
...
PROJECT_NAME = 'ingest'
SUBPROJECT_NAME = 'rds'
SCRIPT_NAME = 'ingest_cumplimiento_despacho_alvi.py'

dag_args = {
    'dag_id': 'ingest_cumplimiento_despacho_alvi',
...
with DAG(**dag_args) as dag:
    ...
    ingest_cumplimiento_despacho = ExtendedDataprocCreateBatchOperator(
        task_id='ingest_cumplimiento_despacho_alvi',
        python_script_path=(
            f'{PROJECT_NAME}/'
            f'{SUBPROJECT_NAME}/'
            'scripts/'
