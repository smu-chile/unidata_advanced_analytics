"""Contains the DAG that loads the table (id, fecha_creacion, comuna)
from PostgreSQL to BigQuery incrementally by date.
"""  # noqa: D205, D210, RUF100
...
PROJECT_NAME = 'ingest'
SUBPROJECT_NAME = 'rds'
SCRIPT_NAME = 'ingest_ordenes_comuna_corregida_alvi.py'

dag_args = {
    'dag_id': 'ingest_ordenes_comuna_corregida_alvi',
...
with DAG(**dag_args) as dag:
    ...
    ingest_mi_tabla = ExtendedDataprocCreateBatchOperator(
        task_id='ingest_ordenes_comuna_corregida_alvi',
        python_script_path=(
            f'{PROJECT_NAME}/'
            f'{SUBPROJECT_NAME}/'
            'scripts/'
