...
SQL_QUERIES = QueryDict({
    ...
    from ( --A1
        select
            ...
            nombre_promocion_ELEGIDOS_AHORRO_S10,
            nombre_promocion_ppal_ELEGIDOS_AHORRO_S10,
        ...
        from (--a1_1
            ...
            from ( --A
                Select
                    ...
                    max(CASE WHEN TIPO_PROMOCION='ELEGIDOS AHORRO S10' then WORKFLOW.nombre_promocion else null end) as nombre_promocion_ELEGIDOS_AHORRO_S10,
                    max(CASE WHEN TIPO_PROMOCION='ELEGIDOS AHORRO S10' then WORKFLOW.nombre_promocion_ppal else null end) as nombre_promocion_ppal_ELEGIDOS_AHORRO_S10,
                    ...
                    max(CASE WHEN TIPO_PROMOCION='ELEGIDOS AHORRO S10' then 1 else 0 end) as ELEGIDOS_AHORRO_S10,
    ...
    SELECT
        ...
        max(CASE WHEN p.TIPO_PROMOCION='ELEGIDOS AHORRO S10' then p.nombre_promocion_ppal else null end) as nombre_promocion_ppal_EA_mat,
