...
dag_args = {
    'dag_id': 'customer_segmentation_sophisticaction_stores_id', #parche 1
...
with DAG(**dag_args) as dag:
    ...
    for store_banner in store_banners:
        task = DataprocCreateBatchOperator(
            task_id=(
                'computing_customer_segmentation_sophistication_stores_id_' #parche 3
            ...
            batch={
                'pyspark_batch': {
                    ...
                    'main_python_file_uri': (
                        ...
                        f'{PROJECT_NAME}/'
                        'scripts/'
                        'computing_customer_segmentation_sophistication_stores_id.py'#parche 4
                    ),
                    # Common files
                    'python_file_uris': [
                        (
