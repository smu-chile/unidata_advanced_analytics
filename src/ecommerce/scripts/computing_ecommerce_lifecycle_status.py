...
def segmentarVentanaOptimizada(
    ...
    def _norm_key(x):  # noqa: ANN001, ANN202
    ...
    def _get(d, k):  # noqa: ANN001, ANN202
...
def main() -> None:  # noqa: D103
    ...
    esquema = 'ECOMMERCE'
    tabla = 'ECOMMERCE_LIFECYCLE_STATUS'
