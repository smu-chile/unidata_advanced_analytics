...
# Task 1
# Parche 2: nombre del archivo ajustado.
script1 = 'processed_regression_data_sector_oriente'
use = 'ELASTICITY'
...
dag_args = {
    ...
    'default_args': {
        ...
        'email': ['rlagosg@unidata.cl'], #Parche 4: email owner ajustado.
