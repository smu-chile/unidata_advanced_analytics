...
PROJECT_NAME = 'metodo_incremental_unipay_antiguo'


dag_args = {
    'dag_id': 'unipay_incremental_antiguo',
...
with DAG(**dag_args) as dag:
    ...
    computing_incremental_unipay = (
        ExtendedDataprocCreateBatchOperator(
            task_id='computing_incremental_unipay_antiguo',
            python_script_path=(
                f'{PROJECT_NAME}/'
                'scripts/'
                'computing_incremental_unipay_antiguo.py'
            ),
