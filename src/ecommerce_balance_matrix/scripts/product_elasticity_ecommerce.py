...
def main() -> None:  # noqa: D103
    ...
    # Usuario
    usuario = 'ecommerce_product_elasticity'


    esquema = 'ECOMMERCE'
    tabla = 'ECOMMERCE_PRODUCT_ELASTICITY'

    # Tabla con data procesada
    table_processed_data = f'{proyecto}.TMP.TMP_ECOMMERCE_REGRESSION_PROCESSED_DATA_ELASTICITY'
    ...
    #[PATCH] Almacenamiento de coeficientes para modelos válidos
    ...
    for categoria, df_categoria in df_final.groupby('category_description'):
        for ean in df_categoria['ean'].unique():
            ...
            if verificacionFactibilidadModelo(df_ean):
                ...
                # [PATCH] Guardado de coeficientes para materiales validos.
