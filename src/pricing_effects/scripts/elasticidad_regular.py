# Default
"""Elasticidad de precios V7.x -- metodo regular (sin cascada).

Calcula elasticidad precio-cantidad por material para un store_banner,
usando SOLO periodos con estado='Regular' (sin mezclar regimenes) y
SIN cascada de fallback -- unicamente se reporta evidencia propia. El
resultado se sube a PRECIO_PROMOCIONES.ELASTICITY_REGULAR en BigQuery.
"""
...
def main() -> None:  # noqa: D103
    ...
    # REGION: PASO 1B -- filtrar panel a SOLO periodos REGULARES
    # -------------------------------------------------------------------
    ...
    # con estado='Regular' -- ANTES de calcular calendario, features,
    # clustering, o entrenar cualquier modelo.
    ...
    logger.info(
        f'\nPanel filtrado a REGULAR: {len(df_panel):,} filas de '
