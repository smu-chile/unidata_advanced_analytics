...
def main() -> None:  # noqa: D103
    ...
    # ecommerce_processed_regression_data.py. Ya no hace falta una
    # variable separada por tipo, ambas viven en el mismo esquema.
    ...
    #       OTROS materiales con el MISMO comportamiento, no de "todo el
    #       banner" -- mas relevante economicamente.
    ...
    mediana_banner = propias_para_nivel4['elasticidad_final'].median()
    pendientes_4b = roster['nivel_herencia'] == 'sin_evidencia_definitivo'
    roster.loc[pendientes_4b, 'elasticidad_final'] = mediana_banner
    roster.loc[pendientes_4b, 'nivel_herencia'] = 'banner_completo'
    roster.loc[pendientes_4b, 'metodo'] = 'heredado_banner_completo'

    n_nivel_4b = int((roster['nivel_herencia'] == 'banner_completo').sum())
    logger.info(
        f'Nivel 4b (mediana del banner, ultimo recurso): '
    ...
    mapa_tipo_elasticidad_actualizado = {
        ...
        'banner_completo': 'fallback_banner_completo',
    }
